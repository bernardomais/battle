            <div id="body">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h1 style="border-bottom: 1px solid #D0D0D0;">Batalha: <?= $players[0]->game; ?> > <?= $players[1]->character ?> contra-ataca <?= $players[0]->character ?></h1>
                            ...
                            <div class="panel-body">
                                ...
                                <ul>
                                    ...
                                    <?php if ($players[1]->points > 0): ?>
                                        <li>Força de ataque: <b><?= $players[1]->points ?></b></li>
                                    <?php endif; ?>
                                </ul>
                                ...
                                <?php
                                    if ($players[1]->character_health > 0 && $players[1]->points == 0):
                                        ...
                                        echo form_open(base_url('battle/attackpoints/'), $attr) . 
                                            ...
                                            form_hidden('weapon', $players[1]->weapon_attack) . 
                                            form_hidden('type', 'attack') . 
                                            form_hidden('base_url', 'battle/revenge/'.$id) . 
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <ul>
                                    ...
                                    <li>Força de defesa: <b><?= $players[0]->points ?></b></li>
                                    <?php endif; ?>
                                </ul>
                                ...
                                <?php
                                    if ($players[0]->character_health > 0 && $players[0]->points == 0):
                                        ...
                                        echo form_open(base_url('battle/attackpoints/'), $attr) . 
                                            ...
                                            form_hidden('weapon', $players[0]->weapon_defense) . 
                        ...
                        if (($players[0]->character_health > 0) && ($players[1]->character_health > 0)):
                            if (($players[0]->points != 0) && ($players[1]->points != 0)):
                                ...
                                echo form_open(base_url('battle/attack/'.$id), $attr) . 
                                                ...
                                                '<span class="glyphicon glyphicon-screenshot" aria-hidden="true"></span> Ataque' . 
                                                '</button>' . 
                                                form_close();
                            endif;
                        else:
